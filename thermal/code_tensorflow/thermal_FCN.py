...
import numpy as np
from thermal_1phase_2D_tf_bc2 import load_data_elem
from tqdm import tqdm
import os


f = tf.placeholder(tf.float32, shape=(None, None, None, 1))
u = tf.placeholder(tf.float32, shape=(None, None, None, 1))
...
num_node = 13
u_img, f_img, conductivity = load_data_elem(num_node, noise_mag=0.0)
u_img = u_img.transpose((0,2,1,3))
f_img = f_img.transpose((0,2,1,3))
import scipy.io as sio
data = sio.loadmat('/home/hope-yao/Documents/FEA_Net/thermal/data/bc2/n66_case1.mat')
num_node = 66
test_u_img = data['d'].reshape(1, num_node, num_node, 1).transpose((0, 2, 1, 3))
test_f_img = data['f'].reshape(1, num_node, num_node, 1).transpose((0, 2, 1, 3))
