...
def load_data_elem():
    ...
    if case==0:
        ...
        data = sio.loadmat('/home/hope-yao/Documents/MG_net/thermal/data/0circle.mat')
        mask = np.ones((num_node-1,num_node-1))

    elif case==1:
        # different phase at each side
        data = sio.loadmat('/home/hope-yao/Documents/MG_net/thermal/data/2phase_simpletest.mat')
        mask = np.ones((num_node-1,num_node-1))
        ...
        data = sio.loadmat('/home/hope-yao/Documents/MG_net/thermal/data/1circle_center_25_25_rad_17.mat')
        mask = np.ones((num_node-1,num_node-1))
        for i in range(num_node-1):
            for j in range(num_node-1):
