...
class FEA_Net_h():
    ...
    def apply_physics_constrain(self):
        ...
        self.trainable_var_pl = tf.placeholder(tf.float32, shape=(18*2,))
...
if __name__ == "__main__":
    ...
    print(result.x[9:18].reshape(3,3))
    print(result.x[18:27].reshape(3,3))
    print(result.x[27:].reshape(3,3))
    # # visualize
