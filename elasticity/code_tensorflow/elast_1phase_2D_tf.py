...
def load_data_elem_sp():
    ...
    data = sio.loadmat('/home/hope-yao/Documents/FEA_Net/elasticity/data/singlephase/single_phase_xyfixed_case1.mat')
...
if __name__ == "__main__":
    ...
    num_node, mask_data, resp_data, load_data, rho = load_data_elem_sp()#load_data_elem_1circle()#load_data_elem_micro_noise()# load_data_elem_micro()#
    ...
    #                                                                                                   noise_mag=0.0)
    # mask_data = np.zeros((1, num_node - 1, num_node - 1, 1))  # *0.5
