...
def load_data_elem_3circle():
    num_node = 25
    data = sio.loadmat(
        '/home/hope-yao/Documents/FEA_Net/elasticity/data/biphase/3circles/2D_elastic_24by24_xy_fixed_3circle.mat')
...
if __name__ == '__main__':
    ...
    num_node, mask, u_img, f_img, rho = load_data_elem_3circle()#get_data()
